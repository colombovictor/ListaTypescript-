...
export function exercicio_03() {
    let nome, horastrabalahadas = 0, salario_hora = 0, qtd_homens = 0, qtd_mulheres = 0, total_funcionarios = 0, continuar = 1, sexo, maiorsalario = 0, salario_total = 0, total_salarios = 0, nome_maior = "a", porcetagem_homens = 0, porcetagem_mulheres = 0;
    while (continuar != 0) {
        ...
        console.log("O número percentual de funcionarios homens é" + porcetagem_homens);
        window.alert("O número percentual de funcionarios homens é" + porcetagem_homens);
        console.log("O número percentual de funcionarios Mulheres é" + porcetagem_mulheres);
        window.alert("O número percentual de funcionarios Mulheres é" + porcetagem_mulheres);
    }
}
